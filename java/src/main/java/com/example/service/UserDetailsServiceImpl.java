...
import com.example.repository.user.AppUserRepository;
import com.example.repository.user.UserRoleRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        List<UserRole> userRoles = this.appRoleDAO.findByAppUser(appUser);
